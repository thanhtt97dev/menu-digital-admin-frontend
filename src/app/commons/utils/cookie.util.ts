...
import { COOKIE } from '../constants/configurations/application.constant';
...
export function getRoleId(): string | undefined {
  return getCookie(COOKIE.ROLE_ID);
}

export function setRoleId(id: string): void {
  setCookie(COOKIE.ROLE_ID, id);
}
