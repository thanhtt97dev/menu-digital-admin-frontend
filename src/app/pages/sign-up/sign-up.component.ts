...
import { REGEX } from '@/commons/constants/configurations/regex.constant';
...
export class SignUp {
  ...
  submitForm(): void {
    ...
    this._apiAuth.signUp(payload).subscribe((response: any) => {
      if (response.code !== RESPONSE_CODES.SUCCESS) {
        this.message = response.message;
      } else {
        this.message =
          'Your account sign up successfully! Please check your email!';
      }
    });
  }
}
